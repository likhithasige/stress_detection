...
export default function RegisterPage({ setRoute }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-soft-gradient">
      ...
      >
        <h2 className="text-3xl font-semibold text-deepIndigo mb-6">Join the Journey 🌸</h2>
        <p className="text-gray-600 mb-8">Create your account and start your personalized stress insights.</p>
